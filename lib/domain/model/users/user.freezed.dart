...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, username: $username, password: $password, admin: $admin, lastLoginTime: $lastLoginTime, apiKey: $apiKey)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, username, password, admin, lastLoginTime, apiKey);
